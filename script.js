document.addEventListener('DOMContentLoaded', function() {
	...
	.then(data => {
        ...
        fetch('https://api-mainnet.magiceden.dev/v2/ord/btc/tokens?tokenIds=4cf9254ac5496b1c8b7779c048c6837d0cfede5ba5b7e2d8b19cad2de9fdf127i0&showAll=true&sortBy=priceAsc', options)
        .then(response => response.json())
